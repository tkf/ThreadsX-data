...
| `["foreach_seq_sum_many", ":nvecs => 8", "tx", ":simd => :ivdep"]` |   1.055 μs (5%) |           |                 |             |
...
| `["foreach", "base", "A .= B .+ C"]`                               | 253.349 ms (5%) | 35.658 ms | 305.18 MiB (1%) |    16000001 |
...
| `["sort", "I64 (wide)", "ThreadsX.QuickSort"]`                     |   3.867 ms (5%) |           |   1.01 MiB (1%) |        2236 |
